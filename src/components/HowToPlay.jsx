...
return(
  ...
  <div style={modalStyle}>
    ...
    <p>Two players can play against each other on two different devices. To begin, click the "Online Play" button  button in navigation bar at the top of the screen. You will then be prompted to select either "Player 1" or "Player 2". On a separate device, your opponent must then navigate to this site and select the opposite player.</p>
    <br/>
<p><i><b>This site currently does not support the ability for more than one online game to be played at a time. Game data is synced with only one database.</b></i></p>
